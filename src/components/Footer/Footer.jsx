...
<footer class="w-full py-8 border-t-2 dark:bg-slate-800 dark:border-gray-500">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="max-w-3xl mx-auto ">
                <a  class="flex justify-center ">
                   
                        <img className="w-36  shadow-xl rounded-full bg-white" src="https://i.ibb.co/S69bJX6/sr-food-beverage-ltd-low-resolution-logo-color-on-transparent-background.png" alt="" />
                </a>
                <h3 className="font-bold mt-4 text-center flex justify-center dark:text-slate-50">
      Darussalam, Mirpur-1 
    </h3> 
    <h3 className="font-bold  text-center flex justify-center dark:text-slate-50"> Dhaka-1216</h3>
    <h3 className="font-bold text-center flex justify-center dark:text-slate-50">Mobile No: 01791234674</h3>
                   
                    <div className="flex space-x-10 justify-center pt-8 items-center mb-10">
                    ...
                    <span className="text-lg text-gray-500 text-center block dark:text-slate-200">©<a>Copyright</a> 2024, All rights reserved.</span>
            </div>
        </div>
    </footer>
        </div>
